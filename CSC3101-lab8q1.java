...
public class lab8q1 //this is lab8q1 by Yang Yukun 209796
{
	...
	{	
		try{
			...
			if(!dat.exists()) 
			{
				System.out.println("Can not run because there is no dat file!But don't worry:YANG YUKUN has made for u.");
